...
public class HomeController {
	...
	public List<Ticket> getTicket() {
		List<Ticket> ticket = Arrays.asList(
			new Ticket(1, 3000000, "BinhThuan","HaNoi","adult",30042020,"A"),
			new Ticket(1, 3000000, "HaNoi","BinhThuan","adult",1052020,"A"),
			new Ticket(2, 3500000, "BinhDuong","NhaTrang","adult",1600223,"A"),
			new Ticket(3, 4000000, "HCM","HaNoi","adult",1600423,"C")
			);
		return ticket;
	}
}